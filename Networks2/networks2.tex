...
We conclude that the probability to have all the possible edges in the network is $e^{-N\alpha}e^{-(N-1)2\alpha}\cdots{e^{-1\cdot{N}\alpha}}=\prod_{i=1}^Ne^{-(N-i+1)i\alpha}$
\section{}
