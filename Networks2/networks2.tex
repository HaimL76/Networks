...
\[
P(k>x_{\sfrac{1}{2}})=\frac{C}{1-\gamma}k^{1-\gamma}\bigg\rvert_{x_{\frac{1}{2}}}^{\infty}=\frac{6248}{-1}k^{-1}\bigg\rvert_{x_{\frac{1}{2}}}^{\infty}=0-\frac{-6248}{x_{\frac{1}{2}}}=\frac{1}{2}\Rightarrow{{x_{\frac{1}{2}}=2\cdot6248}=12496}
\]

Hence, the median wage is $12,496$ ILS, which is lower than, but same order of magnitude of, the average wage $13,620$ ILS.
\end{document}
