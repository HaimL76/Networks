...
\[
P(x<x_{\sfrac{1}{2}})=\frac{C}{1-\gamma}x^{1-\gamma}\bigg\rvert_{x_{\min}}^{x_{\sfrac{1}{2}}}=\frac{6248}{-1}x^{-1}\bigg\rvert_{6248}^{x_{\sfrac{1}{2}}}=\frac{-6248}{x_{\frac{1}{2}}}-\frac{-6248}{6248}=\frac{1}{2}\Rightarrow{\frac{6248}{x_{\frac{1}{2}}}}=\frac{1}{2}\Rightarrow\]
...
\[
P(x>x_{\sfrac{1}{2}})=\frac{C}{1-\gamma}x^{1-\gamma}\bigg\rvert_{x_{\frac{1}{2}}}^{\infty}=\frac{6248}{-1}x^{-1}\bigg\rvert_{x_{\frac{1}{2}}}^{\infty}=0-\frac{-6248}{x_{\frac{1}{2}}}=\frac{1}{2}\Rightarrow{{x_{\frac{1}{2}}=2\cdot6248}=12496}
\]
...
\subsection{}
We write $x\in{k}$ to say that $x$ is in the $k$th decile, and denote by $x_k$ the minimum wage in the $k$th decile (where $x_0=x_{\max}$ and $x_{10}=x_{\min}$). Then
\[
P(x\in{K})=P(x_k\leq{x}<x_{k-1})=\frac{C}{1-\gamma}x^{1-\gamma}\bigg\rvert_{x_{k}}^{x_{k-1}}=\frac{C}{1-\gamma}(x_{k-1}^{1-\gamma}-x_k^{1-\gamma})
\]
...
We use our $\gamma$ and $C$ to get

$-6248(\frac{1}{x_{k-1}}-\frac{1}{x_k})=\frac{1}{10}$

We calculate

$\frac{-6248}{x_9}+\frac{6248}{x_{10}}=\frac{6248}{x_{\min}}-\frac{6248}{x_9}=\frac{6248}{6248}-\frac{6248}{x_9}=1-\frac{6248}{x_9}=0.1\Rightarrow{\frac{6248}{x_9}}=0.9\Rightarrow{x_9=6942.222}$

Hence

$\frac{6248}{x_9}-\frac{6248}{x_8}=0.9-\frac{6248}{x_8}=0.1\Rightarrow\frac{6248}{x_8}=0.8\Rightarrow{x_8=7810}$

\[x_{10}=x_{\min}=6248\]
\[x_9=6942.222\]
\[x_8=7810\]
\[x_7=8925.714\]\[x_6=10413.333\]\[x_5=12496\]
\[x_4=15620\]
\[x_3=20826.666\]
\[x_2=31240\]
\[x_1=62480\]

We see that the sequence of differences \[\{a_k\}=\{x_9-x_{10},x_8-x_9,
\dots,x_1-x_2,x_0-x_1\}\]
